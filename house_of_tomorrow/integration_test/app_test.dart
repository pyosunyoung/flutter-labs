...
void main() {
  ...
  group("House Of Tomorrow", () {
    testWidgets('상품 결제', (tester) async {
      /// 앱 실행
      app.main(); // main.dart 파일을 받아옴.
      await tester.pumpAndSettle(); // 프레임 갱신 화면 새로고침?
      await Future.delayed(const Duration(seconds: 1)); // 쇼핑 페이지 받아오기 위해 1초간 기다림
      ...
      await tester.pumpAndSettle();
      await tester.tap(addButton);
      await tester.pumpAndSettle(); // 수량 2만큼 증가
