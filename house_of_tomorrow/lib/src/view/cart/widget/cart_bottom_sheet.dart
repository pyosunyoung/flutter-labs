  ...
  Widget build(BuildContext context) {
    return BaseBottomSheet(
      ...
      padding: EdgeInsets.only(
        top: context.layout(32, desktop: 16), // 기기 사이즈에 따른 반응형 적용
        left: 16,
        right: 16,
        bottom: 16,
      ),
      child: Wrap(
        ...
        children: [
          ...
          Row(
            children: [
              Text(S.current.selectedItems, style: context.typo.headline3),
              const Spacer(),
              Text(
          ...
          Row(
            children: [
              //s current 이건 약속된 글자들?이 모여있는 그런 느낌이거 같은데
              Text(S.current.totalPrice, style: context.typo.headline3),
              const Spacer(),
              Text(
                totalPrice,
                style: context.typo.headline3.copyWith(
