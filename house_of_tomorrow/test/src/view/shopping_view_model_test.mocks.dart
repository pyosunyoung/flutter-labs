...
import 'package:house_of_tomorrow/src/model/product.dart' as _i6;
...
class MockProductRepository extends _i1.Mock implements _i3.ProductRepository {
  ...
  @override
  String get searchProductListUrl =>
      (super.noSuchMethod(
  ...
  _i5.Future<List<_i6.Product>> searchProductList(String? keyword) =>
      (super.noSuchMethod(
            Invocation.method(#searchProductList, [keyword]),
            returnValue: _i5.Future<List<_i6.Product>>.value(<_i6.Product>[]),
            returnValueForMissingStub: _i5.Future<List<_i6.Product>>.value(
              <_i6.Product>[],
            ),
          )
